...
- [`docs/https://github.com/packetThrower/Baudrun/blob/main/docs/examples/theme.example.jsonc`](examples/theme.example.jsonc) —
  annotated version, for reading and learning. Not directly
  importable (Baudrun's JSON parser doesn't accept comments).
- [`docs/https://github.com/packetThrower/Baudrun/blob/main/docs/examples/theme.example.json`](examples/theme.example.json) —
