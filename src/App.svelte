<script lang="ts">
  ...
  onMount(async () => {
    ...
    // (alpha.8 had a show-on-ready block here that built windows
    // invisible and called .show() after applySkin. Reverted —
    // delayed window appearance felt broken; the residual paint
    // flash is the lesser evil.)
